...
class malen_recent_posts_widget extends WP_Widget {
        ...
        function __construct() {
            ...
            parent::__construct(
                ...
                'malen_recent_posts_widget',

                // Widget name will appear in UI

                esc_html__( 'Malen :: Recent Posts', 'malen' ),
                ...
                array(
                    ...
                    'description'                   => esc_html__( 'Add Recent Posts Widget', 'malen' ),
                )
            );
        }
                            ...
                            echo '<div class="recent-post">';
                                    ...
                                    echo '<div class="media-img">';
                                        echo '<a href="'.get_the_permalink().'">';
                                            echo malen_img_tag( array(
                                                "url"   => esc_url( get_the_post_thumbnail_url( null, 'malen_80X80' ) ),
                                            ) );
                                        echo '</a>';
                                    echo '</div>';
                                }
                                echo '<div class="media-body">';
                                   echo '<h4 class="post-title">';
                                    ...
                                    if($show_date){
                                        echo '<a href="'.esc_url( get_author_posts_url( get_the_author_meta('ID') ) ).'"><i class="fa-sharp fa-regular fa-user"></i>'.esc_html__('Post By ', 'malen') . esc_html(ucwords(get_the_author())) . esc_html( get_the_time( ' Y' ) ). '</a>';
                                    }
                                    echo '</div>';
        ...
        public function form( $instance ) {
           ...
           //Post title Count
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'post_count' ); ?>"><?php _e( 'Number of Posts to show:' ,'malen'); ?></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'post_title_count' ); ?>"><?php _e( 'Number of title word to show:' ,'malen'); ?></label>
    ...
    } // Class malen_recent_posts_widget ends here


    // Register and load the widget
    function malen_recent_posts_load_widget() {
        register_widget( 'malen_recent_posts_widget' );
    }
    add_action( 'widgets_init', 'malen_recent_posts_load_widget' );