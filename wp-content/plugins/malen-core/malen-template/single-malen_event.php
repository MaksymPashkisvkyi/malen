    ...
    <div class="container">
        <div class="event-details space-bottom">
            <?php while( have_posts( ) ) :
                the_post();
                 $time       = malen_meta( 'event_time' );
                 $gallery       = malen_meta( 'event_gallery' );
                 $event_info       = malen_meta( 'event_details' );
                 $iframe   = malen_meta( 'event_iframe' );
                 $link1   = malen_meta( 'event_calendar_link' );
                 $link2   = malen_meta( 'event_calendar_link2' );
            ?>
            <?php if(!empty( $gallery)): ?>
            <div class="row event-img-slider th-carousel" id="eventimgslide">
            ...
            <div class="row mb-35 gy-4">
                ...
                <div class="col-lg-5 align-self-center">
                    <div class="btn-group justify-content-lg-end">
                        <a target="_blank" href="<?php echo esc_attr($link1) ?>" class="th-btn wave-btn"><?php echo esc_html__('Save On Calendar', 'malen'); ?></a>
                        <a target="_blank" href="<?php echo esc_attr($link2) ?>" class="th-btn wave-btn"><?php echo esc_html__('Ical Export', 'malen'); ?></a>
                    </div>
                </div>
            </div>
            ...
            <div class="row gy-30">
                <div class="col-lg-7">
                    <h3><?php echo esc_html__('Event Details', 'malen'); ?></h3>
