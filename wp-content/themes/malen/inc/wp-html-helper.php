...
// image default alt
if( !function_exists( 'malen_img_default_alt' ) ){
	function malen_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'malen_img_tag' ) ){
	function malen_img_tag( array $args ){
...
// Anchor Tag
if( !function_exists( 'malen_anchor_tag' ) ){
	function malen_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'malen_heading_tag' ) ){
	function malen_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'malen_paragraph_tag' ) ){
	function malen_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'malen_span_tag' ) ){
	function malen_span_tag( array $args ){
